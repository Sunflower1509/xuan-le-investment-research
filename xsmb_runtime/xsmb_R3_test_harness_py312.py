...
RUNNER=Path('/mnt/data/xsmb_reference_runner_R3_final.py')
...
OUT=Path('/mnt/data/xsmb_R3_test_output')
OUT.mkdir(exist_ok=True)

spec=importlib.util.spec_from_file_location('xsmb_r3',RUNNER)
r=importlib.util.module_from_spec(spec); sys.modules['xsmb_r3']=r; spec.loader.exec_module(r)
...
(OUT/'R3_34_TEST_RESULTS.json').write_text(json.dumps(report,ensure_ascii=False,indent=2),encoding='utf-8')

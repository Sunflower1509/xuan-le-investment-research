...
authority_note: "Operational orchestration document. Executable/live authority remains the frozen MODEL_SPEC, canonical workbook, active runner pin, PROSPECTIVE_LEDGER, immutable manifests, exact-runtime evidence and operational certifications."
change_control: "Any semantic change requires a new document_version and a Git commit. Do not silently edit this file in Drive independently of Git."
---

window.RESEARCH_DATA = {
  "meta": {
    ...
    "note": "Giá đóng cửa, biến động và khối lượng khớp lệnh của 65/65 mã được khóa tại phiên 25/08/2026. OHLC 65/65 mã khớp trực tiếp giữa VNDIRECT Finfo và DNSE EnTrade. Khối lượng khớp 63/65 mã giữa hai nguồn; SHS: VNDIRECT 14.075.800 vs DNSE 14.073.100 (chênh 2.700); VIX: VNDIRECT 73.645.900 vs DNSE 73.645.904 (chênh 4). Website dùng nmVolume từ VNDIRECT Finfo theo quy ước nguồn chính và không suy diễn nguyên nhân sai khác. Không dùng chuỗi giá lịch sử đã điều chỉnh; phần trăm biến động lấy từ dữ liệu phiên VNDIRECT. Vùng mua, fair value, target, stop, recommendation và điều kiện hành động giữ nguyên theo hồ sơ đang công bố."
  },
  "marketSession": {
    "date": "2026-08-25",
